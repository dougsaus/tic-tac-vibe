Please refer to the [Project Genesis](./PROJECT_GENESIS.md) doc for a note from the Author (the only portion of this project, including the rest of this README, that was not generated by AI).
